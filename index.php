	...
	<div id="content" class="content">
		...
		<?php endwhile; ?>
												...
												<!-- <div class='wp-pagenavi'> -->
													<!-- <span class='pages'>第 1 页，共 4 页</span>
													<span class='current'>1</span>
													<a class="page larger" href="http://www.jefway.com/web/page/2">2</a>
													<a class="page larger" href="http://www.jefway.com/web/page/3">3</a>
													<a class="page larger" href="http://www.jefway.com/web/page/4">4</a>
													<a class="nextpostslink" rel="next" href="http://www.jefway.com/web/page/2">&raquo;</a> -->
